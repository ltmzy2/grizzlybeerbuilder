...
import static com.jy.x.common.Constant.SERVICE;
 ...
 **/
public class GenerateInterfaceImplStrategy implements FreemarkerGenStrategy {

    @Override
    public String generate(Configuration cfg,GenPara genPara) throws Exception {
        Map<String, Object> map = new HashMap<>();
        map.put("iClassName", StringUtil.removeFirstName(genPara.getEntityName()) + SERVICE);
        String ftlTemp = "/ServiceImplTemplate.ftl";
