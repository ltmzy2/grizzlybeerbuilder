...
public class LogAcpect {
    ...
    @Before("com.beer.grizzly.aspectj.JoinPointConfig.doServiceAcpect()")
    ...
    @Before("com.beer.grizzly.aspectj.JoinPointConfig.doControllerAcpect()")
    ...
    @After("com.beer.grizzly.aspectj.JoinPointConfig.doControllerAcpect()")
